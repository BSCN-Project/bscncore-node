...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `bscncore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ bscncore-node add wallet-service');
      console.log('    $ bscncore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ bscncore-node remove wallet-service');
      console.log('    $ bscncore-node remove insight-api');
      console.log();
    });
