...
describe('#defaultBaseConfig', function() {
  it('will return expected configuration', function() {
    ...
    bscnd.spawn.datadir.should.equal(home + '/.bscn');
    bscnd.spawn.exec.should.equal(path.resolve(__dirname, '../../bin/bscnd'));
  });
  ...
  it('be able to specify a datadir', function() {
    ...
    info.config.servicesConfig.bscnd.spawn.datadir.should.equal('./data2');
  });
});
